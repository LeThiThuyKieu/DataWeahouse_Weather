-- Tạo databases cho DEV environment
CREATE DATABASE IF NOT EXISTS weatherdb_dev;
CREATE DATABASE IF NOT EXISTS controldb_dev;

-- Sử dụng weatherdb_dev
USE weatherdb_dev;
